...
function ClearedTodoItem({ todo, categories }) {
    ...
    return (
        ...
        <Text className="text-gray-900 dark:text-gray-100 font-medium">{todo.text}</Text>
        <Text className="text-xs text-gray-500 dark:text-gray-400">Category: {categoryName}</Text>
        <Text className="text-xs text-gray-500 dark:text-gray-400">Cleared: {new Date(todo.clearedAt).toLocaleString("es-ES")}</Text>
        </View>
    );
    }
...
/* Styles iguales a los className que ya tienen en este archivo*/

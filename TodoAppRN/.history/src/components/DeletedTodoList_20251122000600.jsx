...
function DeletedTodoItem({ todo, categories }) {
    ...
    return (
        <div className="p-3 mb-2 bg-red-50 dark:bg-gray-900 border border-red-200 dark:border-red-700 rounded-lg">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">Deleted: {new Date(todo.deletedAt).toLocaleString("es-ES")}</p>
        </div>
    );
    }
    ...
    return (
        ...
        {/* Stats */}
        <div className="bg-red-50 dark:bg-gray-900 p-4 rounded-lg border border-red-200 dark:border-red-700">
